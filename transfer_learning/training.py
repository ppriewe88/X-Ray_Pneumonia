...
# use utils-function. Returns tuple of train and validation data as generator-like object, generating batches of given batch size
def get_data(selected_data = "train"):
...
train_data, val_data = get_data(selected_data = "train")
 # %%
' ################################################## defining the model #########################'
# base model
if selected_model == "ResNet":
...
# get test data
test_data_throwaway, test_data = get_data(selected_data = "test")
